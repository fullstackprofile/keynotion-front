...
export default function EventsInner({data}) {
    ...
    return (
      <MainLayoutt>
        <div>
          <EventsInnerHeading id={data.id} title={data.title} the_venue_logo={data.the_venue_logo[0].logo} small_description={data.small_description} cover={data.cover} country={data.country} city={data.city}/>
