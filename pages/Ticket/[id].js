...
export default function Ticket ({data}) {
  ...
  return (
    <MainLayoutt>
    <div>
    <EventsHeading id={id_}  title={data.secondRequestData.title} subTitle={data.secondRequestData.small_description} img="/TicketHeading.png" ticket/>
    <Tickets data={data.firstRequestData} event={data.secondRequestData.title}/>
    <TicketsOnline/>
    <RelatedEvents/>
  </div>
    </MainLayoutt>
