...
const dropdownIcons =[
  {src : "/Facebook.svg", href : "https://www.facebook.com/KEYNOTION/",width : 42, height : 42},
  {src : "/Twitter.svg", href : "https://twitter.com/keynotion/",width : 42, height : 42},
  {src : "/Youtube.svg", href : "https://www.youtube.com/channel/UCmQPP5WqFHwnv1XU7wiTwPg",width : 42, height : 42},
  {src : "/Linkdin.svg", href : "https://www.linkedin.com/company/keynotion/",width : 42, height : 42},
]
    ...
    <>
                    ...
                    <div className={styles.dropdown} onClick={handleOpen}>
                      ...
                      <div className={styles.dropdown_icon_block}>
                        <Image src="/arrowbottom.svg" alt='arrow' width={12} height={12}/>
                      </div>
                        </div>
                      {
                        open && 
                          ...
                          <div className={styles.dropedMenu}>
                            <div className={styles.dropedMenu_up}>
                              ...
                              {modal_1.map(({modalTitle,href,modalTitle_1,subTitle},index)=> 
                                
                              <div className={styles.menuuuu} key={index}>
                                {subTitle && <p className={styles.subTitle}>{subTitle}</p>} 
                                
                                {modalTitle && <Link href={ href ? `/${href}` : "#"} >
