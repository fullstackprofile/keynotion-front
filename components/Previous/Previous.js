...
<div className={styles.previousHeading_wrapper}>
    ...
    <div className={styles.previousHeading_block}>
      <p className={styles.previousHeading_title}>
      {title}
      </p>
     <div className={styles.checkOut_block}>
        <p className={styles.checkOut_title}>Check Out Conjoint 2018 Summits</p>
        <p className={styles.checkOut_subTitle}>Click here to get the PDF of 2018’s events highlights</p>
