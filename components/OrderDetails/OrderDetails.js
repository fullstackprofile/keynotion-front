                ...
                <div className={styles.card_info_block}>
                    ...
                    <div className={styles.card_item}>
                        <div className={styles.item_name_block}>
                                ...
                                <p className={styles.item_name}>Ticket: {items[index]?.title_} - {items[index]?.type} {items[index]?.other_type}</p>
                                
                        </div>
                            <div className={styles.item_right}>
                                <div className={styles.item_quantity_block}>
                                    
                                    <div className={styles.count}><p className={styles.countt}>{items[index]?.count}</p></div>
                                    
                                    </div>
                                
                                <div className={styles.item_price_block}>
                                    <p className={styles.item_price}>{items[index]?.currency}{items[index]?.price}</p>
                            </div>
                            <div className={styles.item_total_block}>
                                <p className={styles.item_total_price}>{items[index]?.currency}{totalPrice}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={styles.total_block}>
                      <div className={styles.subtotal_block}>
                        ...
                        <p className={styles.total_block_price}>{items[index]?.currency}{totalPrice}</p>
                        </div>
                      </div>
                      <div className={styles.vat_block}>
                      <div className={styles.subtotal_block__}>
                        <p className={styles.subtotal_block_title}>Vat:</p>
                        <p className={styles.total_block_price}>{items[index]?.currency}0</p>
                      </div>
                      </div>
                      <div className={styles.vat_block_}>
                        <div className={styles.subtotal_block__}>
                        <p className={styles.subtotal_block_title}>Payment Method:</p>
                        <p className={styles.total_block_price}>Invoice - Direct Bank Transfer</p>
                        </div>
                      </div>
                      <div className={styles.subtotal_block}>
                      <div className={styles.subtotal_block__}>
