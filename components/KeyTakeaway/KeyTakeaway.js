      ...
      <div className={styles.keyTakeaway_body}>
        <div className={styles.top}>
          <div className={styles.who_should}>
            <p className={styles.who_should_title}>
              <span className={styles.liner}>Who</span> Should Attend
            </p>
          ...
          <div className={styles.inner_keyTakeaway}>
            <p className={styles.inner_keyTakeaway_title}>
              Key <span className={styles.liner}>Takeaway</span>
            </p>
            {key_takeaway.map(({ item }, index) => (
              <div key={index} className={styles.inner_keyTakeaway_item}>
                ...
                <span className={styles.inner_keyTakeaway_item_text}>
                  {item}
                </span>
              </div>
            ))}
        ...
        <div className={styles.bottom}>
          <div className={styles.sponsorshipOpportunities}>
            <p className={styles.sponsorshipOpportunities_title}>
              <span className={styles.liner}>Sponsorship</span> Opportunities
            </p>
            <div className={styles.sponsorshipOpportunities_subTitle_block}>
              <p className={styles.sponsorshipOpportunities_subTitle}>
                As our business partner, you can leverage on our event to
                showcase your brand and expertise through our speaking panels,
                booths and exhibition opportunities.
              </p>
              <p className={styles.sponsorshipOpportunities_subTitle}>
                Our attendees attend to seek solutions for their challenges.
                This is your chance to show them how your solution can add
                value.
              </p>
            </div>
