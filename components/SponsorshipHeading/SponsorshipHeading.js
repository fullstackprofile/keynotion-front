...
const content = [
  {
    src: '/speaker.svg',
    title: '10 - 40 Minute Presentation',
    subTitle:
      'Showcase your thought leadership, inspire a global audience with your story through shared case study examples',
    width: 30,
    height: 42,
  },
  {
        ...
        <div className={styles.sponsorshipHeading_content}>
          ...
          <div className={styles.about_sponsoship}>
            ...
            <div className={styles.about_sponsoship_content}>
              {content.map(({ src, title, subTitle, width, height }, index) => (
                <SponsorshipHeadingItem
                  key={index}
                  src={src}
                  title={title}
                  subTitle={subTitle}
