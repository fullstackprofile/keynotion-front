        ...
        <div className={styles.content_card_info}>
            <div className={styles.card_info_block}>
                ...
                <div className={styles.card_items}>
                    {
                      items.map(({id,type,other_type,price,count,currency,title_},index)=> <CardItem title_={title_} key={index+id} count={count} id={id} type={type} other_type={other_type} price={price} currency={currency} />)
                    }
            ...
            <div className={styles.totals_block}>
                    ...
                    <div className={styles.total_block}>
                      <div className={styles.subtotal_block}>
                        ...
                        <p className={styles.total_block_price}>{items[0].currency}{totalPrice}</p>
                        </div>
                      </div>
            ...
            <div className={styles.return_coupon}>
              {
                !user && <div className={styles.return}>
                <div className={styles.person_img}>
                <Image src="/Person.png" width={32} height={30}/>
                </div>
              <p className={styles.return_text}>Returning Customer? <span className={styles.liner}>Click Here To Login</span></p>
              </div>
              }
                    <div className={styles.coupon}>
                      ...
                      <div >
                        <p className={styles.return_text}>Have A Coupon? <span className={styles.liner} onClick={onShowCoupon}>Click Here To Enter Your Code</span></p>
                      </div>
                    </div>
                        { open && <CouponForm /> }
            </div>
