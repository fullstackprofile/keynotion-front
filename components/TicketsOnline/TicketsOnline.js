      ...
      <div className={styles.body}>
        <div className={styles.left}>
          <p className={styles.left_title}>
            Ticket: Operational Excellence & Process Transformation Summit
            Online
          </p>
          <div className={styles.links}>
            {icons.map(({ src, href, width, height }, index) => (
        ...
        <div className={styles.right}>
          <p className={styles.right_title}>
            SKU <span className={styles.liner}>N/A</span>
          </p>
          <p className={styles.right_subTitle}>
            Category: <span className={styles.liner}>Ticket</span>
          </p>
        </div>
      </div>
    </div>
