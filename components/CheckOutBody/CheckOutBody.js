...
export const CheckOutBody = ({ticketName,count,type,other_type,index}) => {
  ...
  const onSubmit = handleSubmit(data => {
    if(data.order_type == "Invoice - Direct Bank Transfer"){
      ...
      router.push(`/DirectBankTransfer/${context.session.itemsss[index].order_number}`)
    }
    // console.log(data);
  });
    ...
    <div className={styles.checkOutBody}>
      ...
      />
       <Controller
            ...
            <Input type="text"  {...field} placeholder="Enter Your Region Name"/> 
            <p className={styles.error}>{error?.message}</p>
            </div>}
        />
        <Controller
            ...
            <Input type="text"  {...field} placeholder="Enter Your City / Town"/> 
            <p className={styles.error}>{error?.message}</p>
            </div>}
        />
        <Controller
            ...
            <Input type="text"  {...field} placeholder="Enter Your Street Address"/> 
            <p className={styles.error}>{error?.message}</p>
            </div>}
        />
        <Controller
            ...
            <Input type="text"  {...field} placeholder="Enter Your PostCode/Zip"/> 
            <p className={styles.error}>{error?.message}</p>
            </div>}
        />
        <Controller
            ...
            <Controller
                    ...
                    <div className={styles.dialog_content}>
                      ...
                      <div className={styles.cards_logo}>
                        <div>
                          <Image src="/MasterCardLogo.png" width={48} height={28} />
                        </div>
                        <div>
                          <Image src="/VisaCardLogo.png" width={38} height={30} />
                        </div>
            ...
            />
             <Controller
                    ...
                    <div className={styles.dialog_content}>
                      ...
                      />
                      <div className={styles.labell}>
                      <p className={styles.labell_name}>Invoice - Direct Bank Transfer</p>
                      </div>
                      </div>
                    </div>}
            />
             <Controller
                    ...
                    <div className={styles.dialog_content}>
                      ...
                      <div>
                          <Image src="/AmericanExpressLogo.png" width={38} height={38} />
                      </div>
                      </div>
                      </div>
                    </div>}
            ...
            <div className={styles.order_type_block_bottom}>
              <p className={styles.privacy}>I´ve read and accept the terms and conditions as well as the <span className={styles.liner} onClick={goPrivacy} >privacy policy.</span></p>
            </div>
            </div>
